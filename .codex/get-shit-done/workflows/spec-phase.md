...
```bash
INIT=$(node "C:/Users/ahifr/Downloads/alo-ai/.codex/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/ahifr/Downloads/alo-ai/.codex/get-shit-done/templates/spec.md.
