...
```bash
node "C:/Users/ahifr/Downloads/alo-ai/.codex/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `C:/Users/ahifr/Downloads/alo-ai/.codex/get-shit-done/templates/retrospective.md`.
