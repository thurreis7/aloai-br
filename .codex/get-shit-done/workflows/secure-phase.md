...
```
Task(
  prompt="Read C:/Users/ahifr/Downloads/alo-ai/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/ahifr/Downloads/alo-ai/.codex/get-shit-done/templates/SECURITY.md`
